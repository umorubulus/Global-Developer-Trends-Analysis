...
- Converted categorical variables (e.g., Age) into numerical formats
...
### 📈 Exploratory Data Analysis
  ...
  - Histograms (Compensation, Experience)
  - Box plots (Age, Compensation)
  #### 🔗 Relationship Analysis
  - Scatter plots (Age vs Compensation, Experience vs Satisfaction)
  - Bubble plots (Compensation vs Satisfaction with Age as size)
  #### 🧩 Composition Analysis
  - Pie charts (Languages, Databases, Tools)
  - Stacked charts (Job satisfaction across demographics)
  #### ⚖️ Comparison Analysis
  - Bar charts (Country, Roles, Databases)
  - Line charts (Compensation trends over age & experience)
---
### 📊 Dashboard
